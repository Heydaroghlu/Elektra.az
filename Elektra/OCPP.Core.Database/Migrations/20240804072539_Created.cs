        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChargePointId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ConnectorId = table.Column<int>(type: "int", nullable: false),
                    StartTagId = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    ...
                    StopTagId = table.Column<string>(type: "nvarchar(50)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ChargePointId");
                    table.ForeignKey(
                        name: "FK_Transactions_ChargeTags_StartTagId",
                        column: x => x.StartTagId,
                        principalTable: "ChargeTags",
                        principalColumn: "TagId");
                    table.ForeignKey(
                        name: "FK_Transactions_ChargeTags_StopTagId",
                        column: x => x.StopTagId,
                        principalTable: "ChargeTags",
                        principalColumn: "TagId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_StartTagId",
                table: "Transactions",
                column: "StartTagId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_StopTagId",
                table: "Transactions",
                column: "StopTagId");
        }
