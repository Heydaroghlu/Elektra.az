...
{
    public partial class OCPPCoreContext : IdentityDbContext<AppUser>
    {
        ...
        public DbSet<ChargeLocation> ChargeLocations { get; set; }
        public DbSet<Wishlist> Wishlists { get; set; }
        public DbSet<CpImage> CpImages { get; set; }
